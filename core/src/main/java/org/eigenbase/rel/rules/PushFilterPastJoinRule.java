...
public abstract class PushFilterPastJoinRule extends RelOptRule {
  ...
  public static final PushFilterPastJoinRule FILTER_ON_JOIN = getFilterOnJoinWithCopy(null);
  ...
  public static PushFilterPastJoinRule getFilterOnJoinWithCopy(Function2<RelNode, RelNode, Void> onCopyHook){
